...
class Markets extends base_1.Module {
    ...
    async getDailyVolumes() {
        ...
        const timestamp = LAST_DAY_UNIX_TIMESTAMP + common_1.TIMEZONE_OFFSET_SEC;
        const variables = {
            timestamp: timestamp,
        };
        return (0, graphqlFetcher_1.default)(endpoint, POSITIONS_VOLUME_INFOS_QUERY, variables).then((data) => {
